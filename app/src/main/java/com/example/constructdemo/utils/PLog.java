...
import com.example.constructdemo.BuildConfig;
import com.example.constructdemo.net.AppConstant;
...
public class PLog {
    ...
    private static final String PATH = AppConstant.LOG_CACHE_PATH;
